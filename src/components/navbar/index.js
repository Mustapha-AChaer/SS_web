...
const Navbar = props => {
    ...
    return(
        <animated.nav className="navbar is-fixed-top custom-navbar "
             role="navigation" aria-label="main navigation" style={styles}>
            <div className="container ">
                <div className="navbar-brand">
                    ...
                    <a role="button" className={`navbar-burger ${isOpen ? 'is-active' : ''}`} aria-label="menu" aria-expanded="false" data-target="navbar" onClick={onBurgerClicked}>
                ...
                <div className={`navbar-menu ${isOpen ? 'is-active' : ''}`}>
                    ...
                    <div className="navbar-end has-text-centered">
                        <div className="navbar-item px-1">
                            <a role="button" className="button has-background-hwhite-o-2 is-borderless " href="" target="_blank" rel="noopener noreferrer" onClick={onBurgerClicked}>
